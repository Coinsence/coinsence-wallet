...
export class EtherscanProvider {
  ...
  public async getAllTokenTransfer(walletAddress: string): Promise<Object> {
    ...
    return this.http.get(getUrl).toPromise() as Promise<Object>;
  }

  //TODO need pagination
  public async getContractTokenTransfer(walletAddress: string, contractAddress: string): Promise<Object> {
  ...
  public async getEtherBalance(walletAddress: string): Promise<Object> {
  ...
  public async getTransactions(walletAddress: string): Promise<Object> {
